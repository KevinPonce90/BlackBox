                ...
                <form action="{{ route('provedor.store') }}" method="POST">
                    ...
                    <div class="row justify-content-evenly">
                        <div class="col-4">
                            ...
                            <input type="text" class="form-control" id="" aria-describedby="NombreProvedor" name="nombreP" value="{{ old('nombreP') }}">
                            @error('nombreP')
                            <h4>{{ $message }}</h4>
                            @enderror
                        </div>
                        <div class="col-4">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="Direccion" name="direccion" value="{{ old('direccion') }}">
                            @error('direccion')
                            <h4>{{ $message }}</h4>
                            @enderror
                        </div>
